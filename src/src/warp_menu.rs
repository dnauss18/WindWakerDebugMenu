...
static STAGES_CAVERN: &'static [Stage; 19] = &[("Bomb Island", "Cave01"),
                                               ("Star Island", "Cave02"),
...
static STAGES_DEV: &'static [Stage; 45] = &[("Invisible Island", "A_nami"),
                                            ("E3 Forest", "A_R00"),
                                            ("Amos T", "Amos_T"),
                                            ("Wind Temple", "Cave08"),
...
static STAGES_DRAGON_ROOST_CAVERN: &'static [Stage; 3] = &[("Dungeon", "M_NewD2"),
                                                           ("Boss", "M_DragB"),
                                                           ("Mini Boss", "M_Dra09")];

static STAGES_DRAGON_ROOST_ISLAND: &'static [Stage; 3] = &[("Pond", "Adanmae"),
                                                           ("Komalis Room", "Comori"),
                                                           ("Postal Service", "Atorizk")];

static STAGES_EARTH_TEMPLE: &'static [Stage; 4] = &[("Entrance", "Edaichi"),
                                                    ("Temple", "M_Dai"),
                                                    ("Boss", "M_DaiB"),
                                                    ("Mini Boss", "M_DaiMB")];

static STAGES_FORBIDDEN_WOODS: &'static [Stage; 3] = &[("Dungeon", "kindan"),
                                                       ("Boss", "kinBOSS"),
                                                       ("Mini Boss", "kinMB")];

static STAGES_FOREST_HAVEN: &'static [Stage; 3] = &[("Potion Room", "Ocrogh"),
                                                    ("Forest Haven", "Omori"),
                                                    ("Makars Hiding Place", "Otkura")];

static STAGES_FORSAKEN_FORTRESS: &'static [Stage; 7] = &[("Ganondorfs Room", "M2ganon"),
                                                         ("FF1 Tower", "Mjtower"),
                                                         ("FF2 Tower", "M2tower"),
...
static STAGES_GANONS_TOWER: &'static [Stage; 15] = &[("Entrance", "GanonA"),
...
static STAGES_GREAT_FAIRY: &'static [Stage; 6] = &[("North", "Fairy01"),
                                                   ("East", "Fairy02"),
                                                   ("West", "Fairy03"),
...
static STAGES_HYRULE: &'static [Stage; 3] = &[("Castle", "Hyroom"),
                                              ("Field", "Hyrule"),
                                              ("Master Sword Chamber", "kenroom")];

static STAGES_NINTENDO_GALLERY: &'static [Stage; 8] = &[("Great Sea", "figureA"),
...
static STAGES_OTHER: &'static [Stage; 3] = &[("Name Select", "Name"),
                                             ("Ending", "ENDING"),
                                             ("Title Screen", "sea_T")];

static STAGES_OUTSET: &'static [Stage; 7] = &[("Links House", "LinkRM"),
...
static STAGES_SAVAGE_LABYRINTH: &'static [Stage; 4] = &[("Entrance", "Cave09"),
                                                        ("Room11", "Cave10"),
                                                        ("Room32", "Cave11"),
                                                        ("End", "Cave06")];

static STAGES_SEA: &'static [Stage; 8] = &[("Sea", "sea"),
...
static STAGES_TOWER_OF_THE_GODS: &'static [Stage; 4] = &[("Dungeon", "Siren"),
                                                         ("Boss", "SirenB"),
                                                         ("Mini Boss", "SirenMB"),
                                                         ("Outside", "ADMumi")];

static STAGES_WIND_TEMPLE: &'static [Stage; 4] = &[("Entrance", "Ekaze"),
                                                   ("Temple", "kaze"),
                                                   ("Boss", "kazeB"),
                                                   ("Mini Boss", "kazeMB")];

static STAGES_WINDFALL: &'static [Stage; 8] = &[("Game Room", "Kaisen"),
...
pub fn render() {
    ...
    match unsafe { cursor } {
        ...
        MENU_ITEM_WARP => unsafe {
            if pressed_a {
                let warp = Warp::new(actual_stage_name,
                                     entrance_index,
                                     room_index,
                                     layer_override,
                                     FadeOut::Default,
