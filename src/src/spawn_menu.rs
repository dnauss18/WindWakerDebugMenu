...
static CATEGORIES: [&'static str; 18] = ["Breakables",
                                         "Doors",
                                         "Dungeon Bosses",
                                         "Enemy NPC",
                                         "Exits / Entrances",
...
static BREAKABLES: &'static [Actor; 9] = &[("Sign", "Kanban"),
...
static DUNGEON_BOSSES: &'static [Actor; 6] = &[("Kalle Demos", "Bkm"),
                                               ("Gohdan", "Bst"),
                                               ("Gohma", "Btd"),
                                               ("Molgera", "Bwd"),
                                               ("Ganondorf", "Gnd"),
...
static ENEMY_NPC: &'static [Actor; 32] = &[("Kargaroc", "Bb"),
                                           ("Bokoblin", "Bk"),
                                           ("Quill", "Bm1"),
                                           ("Canon", "Canon"),
                                           ("Big Octo", "Daiocta"),
...
static EXITS_ENTRANCES: &'static [Actor; 3] = &[("Door (0)", "KNOB00"),
                                                ("Door (1)", "KNOB01"),
                                                ("Grotto Entrance", "Pitfall")];

static FOLIAGE: &'static [Actor; 13] = &[("Palm Tree", "Oyashi"),
                                         ("Flower", "flower"),
                                         ("flwr17", "flwr17"),
                                         ("flwr7", "flwr7"),
                                         ("Small Rock (1)", "koisi1"),
...
static FRIENDLY_NPC: &'static [Actor; 13] = &[("Sturgeon", "Aj1"),
                                              ("Grandma", "Ba1"),
                                              ("Great Fairy", "BigElf"),
                                              ("Rito Postman (2)", "Bm2"),
                                              ("Rito Postman (4)", "Bm4"),
...
static GAMEPLAY: &'static [Actor; 22] = &[("Attention Grabber", "AttTag"),
                                          ("Bomb Flower", "BFlower"),
...
static LOD_MODELS: &'static [Actor; 49] = &[("Forsaken Fortress", "LOD01"),
                                            ("Star Island", "LOD02"),
...
static LARGE_OBJECTS: &'static [Actor; 5] = &[("Stall A", "RotenA"),
                                              ("Stall B", "RotenB"),
                                              ("Stall C", "RotenC"),
...
static OBSTACLE: &'static [Actor; 5] = &[("Iron Bars", "Ashut"),
                                         ("Large Rock", "Ebrock"),
                                         ("Spike", "Htoge1"),
                                         ("Eye-Vine Blocker", "Ss"),
                                         ("Tingle", "Tc")];

static STORYLINE: &'static [Actor; 6] = &[("Triangle Island Statue", "Doguu"),
                                          ("Zephos / Cyclos", "Hr"),
                                          ("Din Statue", "MegamiD"),
...
static SWITCHES: &'static [Actor; 9] = &[("\"All Enemies Killed\" Switch", "ALLdie"),
...
static TG_DOORS: &'static [Actor; 12] = &[("KNOB00D", "KNOB00D"),
                                          ("KNOB01D", "KNOB01D"),
                                          ("KNOB03D", "KNOB03D"),
                                          ("ZenS12", "ZenS12"),
...
static TREASURE_CHESTS: &'static [Actor; 20] = &[("Treasure Chest", "takara"),
                                                 ...
                                                 ("Treasure Chest Unlocked by Light Beam",
                                                  "tkrBMs"),
                                                 ("Treasure CTf", "tkrCTf")];

static TRIGGERS: &'static [Actor; 10] = &[("Event Trigger", "TagEv"),
                                          ("Hint Trigger", "TagHt"),
...
static UNCATEGORIZED: &'static [Actor; 452] = &[("Prison Door", "ATdoor"),
                                                ("Ac1", "Ac1"),
                                                ("Old Man Ho Ho", "Ah"),
                                                ...
                                                ("Hmlif", "Hmlif"),
                                                ("Tower of the Gods Magical Chess Piece (1)",
                                                 "Hmon1"),
                                                ("Tower of the Gods Magical Chess Piece (1d)",
                                                 "Hmon1d"),
                                                ("Tower of the Gods Magical Chess Piece (2)",
                                                 "Hmon2"),
                                                ("Tower of the Gods Magical Chess Piece (2d)",
                                                 "Hmon2d"),
                                                ("Beamos (1)", "Hmos1"),
                                                ("Beamos (2)", "Hmos2"),
                                                ("Beamos (3)", "Hmos3"),
                                                ...
                                                ("Hr2", "Hr2"),
                                                ("Tower of the Gods Talking Magical Chess Piece",
                                                 "Hseki1"),
                                                ("Hseki2", "Hseki2"),
                                                ("Hseki3", "Hseki3"),
                                                ("Hseki4", "Hseki4"),
                                                ...
                                                ("Triangular Prism Block Target Location",
                                                 "MtryBCr"),
                                                ("MwtrSB", "MwtrSB"),
                                                ("MygnSB", "MygnSB"),
                                                ("NBOX", "NBOX"),
                                                ...
                                                ("Salvage", "Salvage"),
                                                ("Sarace", "Sarace"),
                                                ("Forsaken Fortress Bokoblin Light Tower",
                                                 "Search"),
                                                ("Fairy", "Sfairy"),
                                                ...
                                                ("TestPo", "TestPo"),
                                                ("Laser Barrier (Iniside Hyrule Castle)",
                                                 "TnTrap"),
                                                ("Tpota", "Tpota"),
                                                ("Red Flag", "TrFlag"),
                                                ...
                                                ("Master Sword (Model from Hyrule Castle Basement)",
                                                 "VmsMS"),
                                                ("VolTag", "VolTag"),
                                                ("Wind Switch", "Vpbot"),
...
pub fn render() {
    ...
    match unsafe { cursor } {
        ...
        MENU_ITEM_SPAWN => {
            if pressed_a {
                ...
                let mut code = format!("ActorTemplate::new(\"{}\", Coord {{ x: {:.1}, y: {:.1}, z: {:.1} }}, \
                                    [0, {:#06X}])",
                                   actual_actor_name,
                                   coord.x,
                                   coord.y,
    ...
    for (index, (line, &content)) in lines.into_iter().skip(3).zip(&contents).enumerate() {
        ...
        match index {
            ...
            MENU_ITEM_X => {
                let _ = write!(line.append(), "{:7.0}", coord.x);
            }
            MENU_ITEM_Y => {
                let _ = write!(line.append(), "{:7.0}", coord.y);
            }
            MENU_ITEM_Z => {
                let _ = write!(line.append(), "{:7.0}", coord.z);
            }
            MENU_ITEM_ROTATION => {
